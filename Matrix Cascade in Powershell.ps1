...
SYNOPSIS
Generates a .ps1 file in temp directory, then starts a Powershell window and turns it into a Matrix Style Screen.
...
#Blank-Screen
Write-Output "$e[38;5;16m$e[48;5;16m$e[H$e[Jm" -NoNewline #blanks the screen with some ANSI escape sequences
...
Add-Content $env:Temp\mat.ps1 "$matty" -Force
Start-Sleep 1

Start-Process PowerShell.exe -ArgumentList (" -ExecutionPolicy Bypass -w maximized -File `"$env:Temp\mat.ps1`"")
